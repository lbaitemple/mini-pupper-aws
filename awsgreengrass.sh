...
cat ${RECIPE_CONFIG_FILE}.template | sed -e "s#S3_BUCKET_PLACEHOLDER#${DEPLOYMENT_BUCKET}#g" -e "s#DOCKER_IMAGE#${DOCKER}#g" -e "s#DANCE_ROUTINE_PLACEHOLDER#${DANCE_FILE}#g"  -e  "s#YOUR_PRIVATE_ECR_IMAGE#${ECR_IMAGE}#g"  > ${RECIPE_CONFIG_FILE}
